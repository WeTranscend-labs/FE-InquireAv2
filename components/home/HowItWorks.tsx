      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-black dark:text-white text-lg md:text-xl max-w-2xl mx-auto">
            Discover how our platform simplifies getting help and earning
            rewards
          </p>
        </motion.div>
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    {/* Card */}
                    <Card
                      className={`p-8 w-full lg:w-[480px] bg-white dark:bg-black border border-black/20 dark:border-white/20 shadow-sm hover:shadow-md transition-all duration-300 ${
...
const steps = [
  {
    title: 'Ask Questions',
    description:
      'Post your programming questions with a token bounty to incentivize quality answers',
    icon: MessageSquare,
  },
  {
    title: 'Set Bounty',
    description:
      'Allocate tokens as a reward for the best answer to your question',
    icon: CircleDollarSign,
  },
  {
    title: 'Get Answers',
    description:
      'Receive detailed answers from experienced developers in the community',
    icon: Zap,
  },
  {
    title: 'Earn Rewards',
    description:
      'Help others by answering questions and earn tokens and reputation',
    icon: Award,
  },
];
